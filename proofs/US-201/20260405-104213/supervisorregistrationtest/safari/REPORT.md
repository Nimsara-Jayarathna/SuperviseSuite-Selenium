...
![tc-01__valid_data___success_modal_shown__then_redirected_to__login](passed/happy_path/20260405-104226-tc-01__valid_data___success_modal_shown__then_redirected_to__login.png)
...
| **Severity** | `normal` |
| **Captured** | `2026-04-05 10:42:28` |

**Test criteria:** Submit the form without filling any field. All five required-field errors must appear.

![tc-02__empty_form_submit___required-field_errors_for_all_five_fields](passed/client-side_validation/20260405-104228-tc-02__empty_form_submit___required-field_errors_for_all_five_fields.png)
...
| **Category** | `client-side_validation` |
| **Severity** | `normal` |
| **Captured** | `2026-04-05 10:42:29` |

**Test criteria:** Enter a gmail.com address. The SLIIT domain validator must reject it.

![tc-03__gmail_address___sliit_institutional_email_domain_error](passed/client-side_validation/20260405-104229-tc-03__gmail_address___sliit_institutional_email_domain_error.png)
...
![tc-04___my.sliit.lk_address___sliit_institutional_email_domain_error](passed/client-side_validation/20260405-104231-tc-04___my.sliit.lk_address___sliit_institutional_email_domain_error.png)
...
| **Category** | `client-side_validation` |
| **Severity** | `minor` |
| **Captured** | `2026-04-05 10:42:32` |

**Test criteria:** Enter a string that is not a valid email address. The format validator must reject it.

![tc-05__malformed_email_string___valid_email_format_error](passed/client-side_validation/20260405-104232-tc-05__malformed_email_string___valid_email_format_error.png)
...
| **Category** | `client-side_validation` |
| **Severity** | `normal` |
| **Captured** | `2026-04-05 10:42:34` |

**Test criteria:** Enter a password shorter than 8 characters. The minimum-length rule must fire.

![tc-06__password___8_chars___minimum_length_error](passed/client-side_validation/20260405-104234-tc-06__password___8_chars___minimum_length_error.png)
...
| **Category** | `client-side_validation` |
| **Severity** | `normal` |
| **Captured** | `2026-04-05 10:42:35` |

**Test criteria:** Enter a password with no uppercase letter. The strength validator must require one.

![tc-07__password_with_no_uppercase_letter___uppercase_required_error](passed/client-side_validation/20260405-104235-tc-07__password_with_no_uppercase_letter___uppercase_required_error.png)
...
| **Category** | `client-side_validation` |
| **Severity** | `normal` |
| **Captured** | `2026-04-05 10:42:37` |

**Test criteria:** Enter a password with no lowercase letter. The strength validator must require one.

![tc-08__password_with_no_lowercase_letter___lowercase_required_error](passed/client-side_validation/20260405-104237-tc-08__password_with_no_lowercase_letter___lowercase_required_error.png)
...
| **Category** | `client-side_validation` |
| **Severity** | `normal` |
| **Captured** | `2026-04-05 10:42:38` |

**Test criteria:** Enter a password with no numeric digit. The strength validator must require one.

![tc-09__password_with_no_digit___digit_required_error](passed/client-side_validation/20260405-104238-tc-09__password_with_no_digit___digit_required_error.png)
...
| **Category** | `client-side_validation` |
| **Severity** | `normal` |
| **Captured** | `2026-04-05 10:42:40` |

**Test criteria:** Enter a password with no special character. The strength validator must require one.

![tc-10__password_with_no_special_character___special_character_required_error](passed/client-side_validation/20260405-104240-tc-10__password_with_no_special_character___special_character_required_error.png)
...
| **Category** | `client-side_validation` |
| **Severity** | `normal` |
| **Captured** | `2026-04-05 10:42:42` |

**Test criteria:** Enter different values for password and confirm password. The mismatch error must appear.

![tc-11__mismatched_passwords___passwords_do_not_match_error](passed/client-side_validation/20260405-104242-tc-11__mismatched_passwords___passwords_do_not_match_error.png)
...
![tc-12__duplicate_email___backend_conflict_error_shown_in_general_error_banner](passed/backend_validation/20260405-104247-tc-12__duplicate_email___backend_conflict_error_shown_in_general_error_banner.png)
...
![tc-13__register_then_login___authenticated_as_supervisor_and_redirected_to_supervisor_dashboard](passed/integration_with_authentication/20260405-104252-tc-13__register_then_login___authenticated_as_supervisor_and_redirected_to_supervisor_dashboard.png)
